...
export default async function page({ params }: ParamsDT) {
    ...
    // Now product is guaranteed to exist (no more "possibly undefined" error)
    let discounted = 0;
        ...
        <div className='mx-auto w-10/12'>
            ...
            <div className='grid grid-cols-4 items-center gap-8'>
                ...
                <div className='p-5 col-span-3 border rounded-2xl shadow'>
                    ...
                    <h2 className='mb-4 text-[#101828] font-bold text-3xl'>{product.title}</h2>
                    ...
                    <h3 className='mb-4'>
                        {product.priceAfterDiscount ? (
                            <div className='flex items-center gap-4'>
                                ...
                                <p className='font-medium text-white bg-red-500 py-1 px-3 rounded-full'>
                    ...
                    <div className='flex items-center gap-2 mb-6'>
                        {product.quantity ? (
                            <div className="flex items-center gap-1.5 text-sm px-3 py-1.5 rounded-full bg-green-50 text-green-700">
                                <span className='w-2 h-2 rounded-full bg-green-500'></span>
                                <p>in stock</p>
                            </div>
                        ) : (
                            <div className="flex items-center gap-1.5 text-sm px-3 py-1.5 rounded-full bg-red-50 text-red-700">
                    ...
                    <p className='border-t-2 border-t-[#F3F4F6] pt-5 text-[#4A5565] font-medium text-base m-2'>
                        {product.description}
                    </p>
